...
//   themKhoaHoc: null,
//   isFetchThemKhoaHoc: false,
//   errThemKhoaHoc: undefined,
//   delKhoaHoc: null,
//   isFetchDelKhoaHoc: false,
//   errDelKhoaHoc: undefined,
//   upDateKhoaHoc: null,
//   isFetchUpdateKhoaHoc: false,
//   errUpdateKhoaHoc: undefined,
// };
...
//       const result = await courseAPI.getKhoaHocList();
//       return result.data;
//     } catch (error) {
...
//     try {
//       const result = await courseAPI.getChiTietKhoaHoc(detail);
//       return result.data;
//     } catch (err) {
...
//   async (danhmuc, { rejectWithValue }) => {
//     try {
//       const result = await courseAPI.getDanhMucKhoaHoc();
//       return result.data;
//     } catch (err) {
//       return rejectWithValue(err.response.data);
//     }
...
//     try {
//       const result = await courseAPI.getKhoaHocTheoDanhMuc(payload);
//       return result;
//     } catch (err) {
//       return rejectWithValue(err.response.data);
//     }
...
//   "quanLyKhoaHocReducer/themKhoaHocUploadHinh",
//   async (data, { rejectWithValue }) => {
//     try {
//       const result = await courseAPI.themKhoaHocUploadHinh(data);
//       return result.data;
//     } catch (err) {
//       return rejectWithValue(err.response.data);
//     }
...
//   "quanLyKhoaHocReducer/xoaKhoaHoc",
//   async (data, { rejectWithValue }) => {
//     try {
//       const result = await courseAPI.xoaKhoaHoc(data);
//       return result.data;
//     } catch (err) {
//       return rejectWithValue(err.response.data);
//     }
...
//   "quanLyKhoaHocReducer/capNhatKhoaHocUpload",
//   async (data, { rejectWithValue }) => {
//     try {
//       const result = await courseAPI.capNhatKhoaHocUpload(data);
//       return result.data;
//     } catch (err) {
//       return rejectWithValue(err.response.data);
//     }
